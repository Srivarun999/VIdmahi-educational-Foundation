export const aboutContent = {
  ...
  closingMessage:
    "We are just getting started. Join us and become part of this exciting journey as we work together to transform rural India through education, one village at a time. Your support means more than you can imagine.",
};
